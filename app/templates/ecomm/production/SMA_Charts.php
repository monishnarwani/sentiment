    ...
    <div class="container body">
      <div class="main_container" >
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu" >
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-bar-chart-o"></i> Product Search <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
              ...
              <div class="menu_section">
                <h3><i class="fa fa-bar-chart-o"></i>Product Analysis</h3>
                <ul class="nav side-menu">
                   <li><a href="#sentiment_score">Sentiment Score</a></li>
                      <li><a href="#sentiment_score">Top Five Reviews</a></li>
					  <li><a href="#featurewords">Features</a></li>
					  <li><a href="#fanalyse">Feature Analysis</a></li> 
                  <li><a href="javascript:void(0)"><i class="fa fa-laptop"></i>Recommendation <span class="label label-success pull-right">Coming Soon</span></a></li>
                </ul>
              </div>
		  ...
		  <div class="nav_menu">
            <nav>
              <div class="nav toggle">
				...
				<div class="row">                  
                <div class="col-md-6 col-sm-6 col-xs-12 form-group pull-left top_search">
                  <div class="input-group">
                    <input id="demo1" type="text" class="form-control" placeholder="Start Searching for products...">
        ...
        <div class="right_col" role="main">
			...
			<div class="container-fluid" id="featurewords">
				<div class="row" >
			  ...
			  <div class="container-fluid" id="fanalyse">
        ...
        <footer>
          <div class="pull-right">
            ProductAnalyst <a href="#">Social media</a>
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
    ...
    series: [
        {
			...
			if ($('#echart_donut').length ){  
			  ...
			  echartDonut.setOption({
				...
				orient:'vertical',
				  x: 'left',
				  data: ['Direct Access', 'E-mail Marketing', 'Union Ad', 'Video Ads', 'Search Engine','SEO']
				},
				toolbox: {
				  show: true,
				  feature: {
